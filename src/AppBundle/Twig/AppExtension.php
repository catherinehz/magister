...
class AppExtension extends \Twig_Extension
{
    ...
    public function getFilters()
    {
        return [
            ...
            new \Twig_SimpleFilter('json_decode', [$this, 'jsonDecode'], ['is_safe' => ['html']]),
        ];
    }
    ...
    /**
     * Perform regular <b>json_decode</b> function from PHP
     * @param string $encodedJsonString 
     * @return mixed Decoded JSON
     */
    public function jsonDecode($encodedJsonString) {
        return json_decode($encodedJsonString);
    }
}
